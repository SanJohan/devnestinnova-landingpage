    ...
    <div className="py-16 md:py-24 bg-bacgkround ">
      <div className="container mx-auto px-4 md:px-20">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm h-full glassmorphism group hover:shadow-secondary/30 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 text-center">
